...
export OMP_NUM_THREADS=12    # this is critical to ensure dataloaders uses all CPUs for torchrun!
...
srun --cpu-bind=none python src/train.py experiment=fp32_flash_attn_bs6
